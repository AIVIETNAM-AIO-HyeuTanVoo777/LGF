...
Table~\ref{tab:iitd} reports the IITD within split. B6 remains competitive and improves over B2, but B1 remains the strongest method on this split. This result is important for scope control: the paper should not claim dataset-wide dominance from the current evidence.

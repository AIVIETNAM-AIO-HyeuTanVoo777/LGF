...
The IITD subject-disjoint within-session protocol is included as secondary validation, not as cross-session evidence. It shows that B6 is competitive with B1, with very small mean deltas in Rank-1, Rank-5, EER, and TAR@FAR=$10^{-2}$, but a negative delta at TAR@FAR=$10^{-3}$. This reinforces the paper's protocol-sensitive interpretation rather than a universal improvement claim.

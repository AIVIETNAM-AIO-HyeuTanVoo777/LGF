...
The B1, B4, B6, and B7 ablation results are used as diagnostic evidence for interpreting the effect of ArcFace, BNNeck, and light SupCon supervision. These results are not used as the final basis for a general improvement claim because the final Tongji results are reported under the stricter development/test palm-class-disjoint protocol.

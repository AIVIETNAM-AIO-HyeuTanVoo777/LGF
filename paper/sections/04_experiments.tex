...
TODO: Add exact hardware and software environment if a verified hardware record is available. The current evidence files report latency values, but the current draft does not yet include a verified full hardware description.

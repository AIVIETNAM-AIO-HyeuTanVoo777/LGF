...
Fixed-Gabor texture features are included as a palmprint-specific reference baseline because Gabor-style orientation coding is historically important in palmprint recognition \cite{kong2004competitive,genovese2019palmnet,liang2021compnet}. However, this baseline is not the main method and is not treated as a reimplementation of PalmNet, CompNet, or Competitive Code. The present evidence does not support a learnable-Gabor, universal BNNeck + ArcFace, state-of-the-art, or cross-dataset robustness claim. The supported claim is a scoped component evaluation under the stated Tongji and IITD protocols, with fixed Gabor used only as a protocol-normalized classical reference point.

...
Gabor and other texture filters remain important context for palmprint recognition because they encode local ridge and crease patterns. However, the current subject-disjoint evidence does not support a Gabor-centered paper claim or a fixed-Gabor dominance claim. Fixed-Gabor variants remain useful baselines, but this work does not frame Gabor filtering as the source of the primary empirical improvement claim.

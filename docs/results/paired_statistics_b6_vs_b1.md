# Paired Statistical Evidence: M6 vs M1
...
- Delta definition: M6 minus M1.
- Positive Rank/TAR/Macro-F1 deltas favor M6.
- Positive EER deltas indicate worse performance for M6.
...
|---|---:|---:|---:|---:|---|
| Rank-1 | -1.18 | 3.26 | [-3.32, +1.26] | 0.4688 | M6 worse |
| Rank-5 | -1.00 | 1.87 | [-2.35, +0.39] | 0.2500 | M6 worse |
| Macro-F1 | -1.31 | 3.62 | [-3.67, +1.44] | 0.4688 | M6 worse |
| EER | +1.01 | 0.73 | [+0.48, +1.52] | 0.0312 | M6 worse |
| TAR@FAR=1e-2 | -2.39 | 4.15 | [-5.29, +0.58] | 0.2500 | M6 worse |
| TAR@FAR=1e-3 | -2.07 | 8.91 | [-8.47, +3.62] | 0.5625 | M6 worse |

## Interpretation
- The mean paired deltas are negative for Rank-1, Rank-5, Macro-F1, TAR@FAR=1e-2, and TAR@FAR=1e-3, and positive for EER.
- This direction of change is consistently unfavorable to M6 on the bidirectional average.
